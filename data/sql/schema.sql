...
CREATE TABLE page (id BIGSERIAL, header VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL UNIQUE, type VARCHAR(32) DEFAULT 'user' NOT NULL, meta_keywords TEXT DEFAULT NULL, meta_description TEXT DEFAULT NULL, meta_indexing BOOLEAN DEFAULT 'true', created_at TIMESTAMP NOT NULL, updated_at TIMESTAMP NOT NULL, PRIMARY KEY(id));
...
ALTER TABLE block ADD CONSTRAINT block_parent_id_block_id FOREIGN KEY (parent_id) REFERENCES block(id) ON UPDATE CASCADE ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE;
