...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_bar">
    <?php include_partial('block/filters', array('form' => $filters, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('block_collection', array('action' => 'batch')) ?>" method="post">
    <?php include_partial('block/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper)) ?>
    <ul class="sf_admin_actions">
      <?php include_partial('block/list_batch_actions', array('helper' => $helper)) ?>
      <?php include_partial('block/list_actions', array('helper' => $helper)) ?>
    </ul>
    </form>
  </div>
